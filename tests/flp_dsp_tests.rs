...
use opus::silk::encoder_flp::find_ltp::{
    silk_corr_matrix_flp, silk_corr_vector_flp, silk_find_ltp_flp,
};
use opus::silk::encoder_flp::quant_ltp_gains::silk_quant_ltp_gains;
use opus::silk::{LTP_ORDER, MAX_NB_SUBFR};
...
use opus::silk::encoder_flp::ltp_scale_ctrl::silk_ltp_scale_ctrl_flp;
use opus::silk::{CODE_CONDITIONALLY, CODE_INDEPENDENTLY};
