...
use crate::silk::lpc_analysis::silk_burg_modified_flp;
use crate::silk::{MAX_LPC_ORDER, MAX_NB_SUBFR, silk_interpolate_i16};
...
pub fn silk_find_lpc_flp(
    ...
    *nlsf_interp_coef_q2 = 4;
    ...
    if use_interpolated_nlsfs && !first_frame_after_reset && nb_subfr == MAX_NB_SUBFR {
        ...
        const MAX_FILTER_LEN: usize = 2 * (MAX_LPC_ORDER + crate::silk::MAX_SUB_FRAME_LENGTH);
