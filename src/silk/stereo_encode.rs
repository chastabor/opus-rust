...
use crate::silk::signal_processing::silk_inner_prod_aligned_scale;
...
mod tests {
    ...
    fn test_stereo_encode_pred_roundtrip() {
        ...
        crate::silk::stereo::silk_stereo_decode_pred(&mut dec, &mut dec_pred_q13);
    ...
    fn test_stereo_encode_mid_only_roundtrip() {
        ...
        for flag in 0..=1i8 {
            ...
            let decoded = crate::silk::stereo::silk_stereo_decode_mid_only(&mut dec);
