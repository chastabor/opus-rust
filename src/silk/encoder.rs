...
use crate::silk::nlsf::*;
use crate::silk::nlsf_encode;
use crate::silk::noise_shape_analysis;
use crate::silk::nsq::{self, MAX_SHAPE_LPC_ORDER, NsqState};
...
pub struct SilkEncoder {
    ...
    stereo_state: crate::silk::stereo_encode::StereoEncState,
    initialized: bool,
    scratch: SilkScratch,
...
impl SilkEncoder {
    ...
    pub fn new() -> Self {
        Self {
            ...
            stereo_state: crate::silk::stereo_encode::StereoEncState::default(),
            initialized: false,
    ...
    pub fn encode_stereo(
        ...
        crate::silk::stereo_encode::silk_stereo_lr_to_ms(
        ...
        crate::silk::stereo_encode::silk_stereo_encode_pred(enc, &ix);

        // Write mid-only flag if we have 2 internal channels
        if self.n_channels_internal == 2 {
            crate::silk::stereo_encode::silk_stereo_encode_mid_only(enc, mid_only_flag);
        }
