...
pub fn init_pitchdnn(arrays: &[WeightArray]) -> Result<PitchDnn, WeightError> {
    ...
    Ok(PitchDnn {
        dense_if_upsampler_1: linear_init(
            arrays,
            Some("dense_if_upsampler_1_bias"), None,
            Some("dense_if_upsampler_1_weights"), None,
            None, None,
            NB_IF_FEATURES, if_up1_out,
        )?,
        dense_if_upsampler_2: linear_init(
            arrays,
            Some("dense_if_upsampler_2_bias"), None,
            Some("dense_if_upsampler_2_weights"), None,
            None, None,
            if_up1_out, if_up2_out,
        )?,
        conv2d_1: conv2d_init(
            arrays,
            Some("conv2d_1_bias"), Some("conv2d_1_weights"),
            2, conv1_out, 3, 3,
        )?,
        conv2d_2: conv2d_init(
            arrays,
            Some("conv2d_2_bias"), Some("conv2d_2_weights"),
            conv1_out, conv2_out, 3, 3,
        )?,
        dense_downsampler: linear_init(
            arrays,
            Some("dense_downsampler_bias"), None,
            Some("dense_downsampler_weights"), None,
            None, None,
            NB_XCORR_FEATURES + if_up2_out, ds_out,
        )?,
        gru_1_input: linear_init(
            arrays,
            Some("gru_1_input_bias"), None,
            Some("gru_1_input_weights"), None,
            None, None,
            ds_out, gru_3n,
        )?,
        gru_1_recurrent: linear_init(
            ...
            Some("gru_1_recurrent_weights"), None,
            None, Some("gru_1_recurrent_diag"), None,
            gru_3n / 3, gru_3n,
        )?,
        dense_final_upsampler: linear_init(
            arrays,
            Some("dense_final_upsampler_bias"), None,
            Some("dense_final_upsampler_weights"), None,
            None, None,
            gru_3n / 3,
